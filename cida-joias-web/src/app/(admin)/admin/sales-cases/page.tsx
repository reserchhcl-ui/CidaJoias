...
export default function AdminSalesCasesPage() {
  ...
  const { data: cases, isLoading } = useQuery({
    ...
    queryFn: salesCaseService.getAllCases,
  });
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-md border bg-white overflow-hidden">
        {/* RESPONSIVIDADE: Scroll horizontal para tabelas em mobile */}
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                {/* Ocultar datas em mobile para economizar espaço */}
                ...
                <TableRow key={c.id}>
                  ...
                  <TableCell>
                     <div className="flex flex-col">
                        <span className="font-medium">ID: {c.sales_rep_id}</span>
                        {/* Se tivéssemos o nome expandido, colocaria aqui */}
                     </div>
                  </TableCell>
                  ...
                  <TableCell className="text-right">
                    <div className="flex justify-end gap-1">
                        <Button variant="ghost" size="icon" asChild>
                            <Link href={`/admin/sales-cases/${c.id}`}>
